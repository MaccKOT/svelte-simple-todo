<script>
  ...
  function addTodo(event) {
    if (event.key === "Enter") {
      ...
      //hack for reactive, because push dont change state
      // todos.push({
      //   id: tempId,
      //   completed: false,
      //   title: newTodo,
  ...
  //not really needed, just for life cycle example
  onMount(async () => {
...
<main>
  <div class="container is-fluid">
    ...
    <img src={'/img/svelte-hor.svg'} alt="svelte logo" class="logo" />
      ...
      <div class="todo-item">
        <div class="todo-item-left" transition:fly={{ y: 20, duration: 300 }}>
          ...
          {:else}
            ...
            <input
              class="todo-item-edit input is-danger"
        ...
        <div class="remove-item" on:click={() => deleteTodo(todo.id)}>
          <img class="trashcan" src={'/img/ios-trash.svg'} alt="delete todo" />
        </div>
      </div>
    {/each}
    ...
    <div class="extra-container">
      ...
      <span class="tag is-warning">
        {todosRemaining} {todosRemaining === 1 ? 'item' : 'items'} left
      </span>
    </div>
    ...
    <div class="extra-container">
      ...
      <button class="button is-success" on:click={clearCompleted}>
        Clear Completed
      </button>
